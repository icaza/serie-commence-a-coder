...
namespace Premier
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            Chk_Tiktok.Click += new EventHandler(Chk_Tiktok_Click);
        }
        ...
        private void Bouton_Btn_Click(object sender, EventArgs e)
        {
            ...
            else if (Chk_Tiktok.Checked == true)
            {
                Process.Start("https://www.tiktok.com/search?q=" + ZoneText_Txt.Text);
            }
        ...
        private void Chk_Wiki_Click(object sender, EventArgs e)
        {
            ...
            {
                Chk_Tiktok.Checked = true;
            }
        }

        private void Chk_Tiktok_Click(object sender, EventArgs e)
        {
            if (Chk_Tiktok.Checked == true)
            {
                Chk_Google.Checked = false;
                Chk_Wiki.Checked = false;
            }
